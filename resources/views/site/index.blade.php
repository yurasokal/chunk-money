            ...
            <main class="main">
                            ...
                            <div class="form__checkbox">
                                ...
                                <div class="form__terms">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        class="form__link form__link-apper"
                                    >
                                        &#8226; Terms of use
                                    </a>
                                    and
                ...
                <section class="forgotPassword">
                    <div class="forgotPassword__wrapper">
                        <form class="forgotPassword__form form">
                            <h2 class="form__heading">Forgot password?</h2>
                            <div class="form__text">Enter the email address that you used to create your Chunk account and we will send you a reset link.</div>
                            <div class="form__inputs">
                                <input
                                    class="form__item"
                                    type="email"
                            ...
                            <button class="form__button button">Reset Password</button>
                            <div class="form__goToCreateAccount">
                                Already have an account?
                                <a
                                    rel="noopener noreferrer"
                        ...
                        <div class="forgotPassword__photo">
                            <img
                                class="forgotPassword__img"
                ...
                <section class="resetPassword">
                    <div class="resetPassword__wrapper">
                        <form class="resetPassword__form form">
                            <h2 class="form__heading">Reset your password</h2>
                            <div class="form__text">Please check your email and enter the code that we sent you below.</div>
                            <div class="form__inputs">
                                <input
                                    class="form__item"
                                    type="text"
                        ...
                        <div class="resetPassword__photo">
                            <img
                                class="resetPassword__img"
                                src="{{ asset('/images/password.png') }}"
                                alt="icon tbd"
                            >
                        </div>
                ...
                <section class="newPassword">
                    <div class="newPassword__wrapper">
                        <form class="newPassword__form form">
                            <h2 class="form__heading">New password</h2>
                            <div class="form__text">Please enter a new password to recover your account.</div>
                            <div class="form__inputs">
                                <input
                                    class="form__item"
                                    type="password"
                        ...
                        <div class="newPassword__photo">
                            <img
                                class="newPassword__img"
                                src="{{ asset('/images/password.png') }}"
                                alt="icon tbd"
                            >
                        </div>
